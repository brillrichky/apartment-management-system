...
const initialState = { //1
    units: [],
    isLoading: true, //biar ga lama loadingnya pas dibackend
    action: new Date(). getTime()
}

const name = 'unit';

export const fetchUnits = createAsyncThunk( // 10 digunakan u/segala macam fungsi yang asynkronus
    'units/getAll', // 11 parameter pertamanya guests, namenya kan: 'guest',
    async () => { //12 asyn function call backnya
        const units = await apartmentAPI.getAllUnits(); //13 api nya kita panggil disini yang guestAPI.js
